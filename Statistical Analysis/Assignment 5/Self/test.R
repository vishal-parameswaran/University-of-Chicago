...
dat <- read.table(paste(dataPath,'Week5_Test_Sample.csv',sep = '/'), header=TRUE,sep = " ")
...
# Create selectors
Train.Sample.Selector<-dat$Input>=1
...
matplot(dat$Input,cbind(dat$Output,Subsample.Steeper$steeperOutput, Subsample.Flatter$flatterOutput),
